	...
	<div class="topbar d-flex align-items-center">
		<nav class="navbar navbar-expand">
			<div class="topbar-logo-header">
				<div class="">
					<img src="https://cdn.pixabay.com/photo/2024/02/04/09/53/ai-generated-8551847_1280.png" class="logo-icon" alt="logo icon">
				</div>
				<div class="">
					<h4 class="logo-text text-dark">KYLA</h4>
				</div>
			</div>
			...
			<div class="user-box dropdown">
				<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
					...
					<img src="https://cdn.pixabay.com/photo/2024/02/04/09/53/ai-generated-8551847_1280.png" class="user-img" alt="user avatar">
					<div class="user-info ps-3">
						<p class="user-name mb-0">KYLA</p>
