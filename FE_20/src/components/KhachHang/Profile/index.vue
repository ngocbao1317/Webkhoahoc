                        ...
                        <ul class="nav nav-tabs nav-primary" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link" data-bs-toggle="tab" href="#naptientab" role="tab"
                                    ...
                                    <div class="tab-title">Nap tien</div>
                                </a>
                            </li>
                        </ul>
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                <div class="d-flex flex-column align-items-center text-center">
                                                    <img src="" alt="">
                                                    <div class="mt-3">
                                                        <h4>Duong Ngoc Bao</h4>
                                                        <p class="text-secondary mb-1">kyla@gmail.com</p>
                                                        <p class="text-secondary mb-1">0979123528</p>
                                                        <p class="text-muted font-size-sm ">Quang Ngai</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="alert alert-success" role="alert">
                                                    Bạn hãy thanh toán số tiền qua QR này, Số tiền này sẽ được tự động xác nhận sau vài phút !
                                                </div>
                                                <div class="row justify-content-center align-items-center">
                                                    <img src="/src/assets/images/qr.png" alt="" class="img-fluid " style="width: 50%;" >
                                                </div>
                                            </div>
