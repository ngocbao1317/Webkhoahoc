    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="text-center">
                <button type="button" class="btn btn-primary px-5 radius-30 mt-2">ĐĂNG KÝ HỌC</button>
            </div>
...
export default {
    ...
    methods: {
        loadChiTietKhoaHoc() {
            axios
                .get('http://localhost:8000/api/home-page/loai-khoa-hoc/chi-tiet/' + this.id_khoa_hoc)
                .then(response => {
                    if (response.data.status == 1) {
                        this.chi_tiet_khoa_hoc = response.data.data;
                    } else {
